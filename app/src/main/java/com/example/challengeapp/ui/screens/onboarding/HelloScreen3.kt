...
@Composable
fun HelloScreen3(navController: NavController) {
    Column(
        ...
        Box( 
            ...
            Image(
                painter = painterResource(R.drawable.woman_w_emojis),
        ...
        BigTitle( modifier = Modifier.padding(top = 26.dp),"Conheça a si mesmo")

        Text(
            "Visualize padrões emocionais, entenda como se sente ao longo do tempo e previna riscos com mais consciência e equilíbrio.",
            textAlign = TextAlign.Center,
            color = TextBlue,
            modifier = Modifier.padding(vertical = 28.dp, horizontal = 34.dp)
        )
        OnboardingPagination(LightBlue, LightBlue, MainBlue)
        RoundedButton(Modifier.padding(top = 16.dp, bottom = 24.dp),"Entre ou crie sua conta") {
            navController.navigate("signUp") {
                popUpTo("hello3") { inclusive = true }
            }
        }
    }
}
